...
namespace lpsolve55
{
    public static class lpsolve
    {
        ...
        [DllImport(dllFileNameLinux, SetLastError = true)]
        ...
        [DllImport(dllFileNameLinux, CharSet = CharSet.Ansi, BestFitMapping = false, ThrowOnUnmappableChar = true, SetLastError = true)]
        ...
        //[DllImport(dllFileNameLinux, SetLastError=true)] public static extern string get_col_name(IntPtr lp, int column);
#if lpsolve_unsafe
    [DllImport(dllFileNameLinux, EntryPoint = "get_col_name", SetLastError = true)] private unsafe static extern IntPtr get_col_name_c(IntPtr lp, int column);
#endif
        [DllImport(dllFileNameLinux, SetLastError = true)]
        ...
        //[DllImport(dllFileNameLinux, SetLastError=true)] public static extern string get_lp_name(IntPtr lp);
#if lpsolve_unsafe
    [DllImport(dllFileNameLinux, EntryPoint = "get_lp_name", SetLastError=true)] private unsafe static extern IntPtr get_lp_name_c(IntPtr lp);
#endif
        [DllImport(dllFileNameLinux, SetLastError = true)]
        ...
        //[DllImport(dllFileNameLinux, SetLastError=true)] public static extern string get_origcol_name(IntPtr lp, int column);
#if lpsolve_unsafe
    [DllImport(dllFileNameLinux, EntryPoint = "get_origcol_name", SetLastError=true)] private unsafe static extern IntPtr get_origcol_name_c(IntPtr lp, int column);
#endif
        //[DllImport(dllFileNameLinux, SetLastError=true)] public static extern string get_origrow_name(IntPtr lp, int row);
#if lpsolve_unsafe
    [DllImport(dllFileNameLinux, EntryPoint = "get_origrow_name", SetLastError=true)] private unsafe static extern IntPtr get_origrow_name_c(IntPtr lp, int row);
#endif
        [DllImport(dllFileNameLinux, SetLastError = true)]
        ...
        //[DllImport(dllFileNameLinux, SetLastError=true)] public static extern string get_row_name(IntPtr lp, int row);
#if lpsolve_unsafe
    [DllImport(dllFileNameLinux, EntryPoint = "get_row_name", SetLastError=true)] private unsafe static extern IntPtr get_row_name_c(IntPtr lp, int row);
#endif
        [DllImport(dllFileNameLinux, SetLastError = true)]
        ...
        //[DllImport(dllFileNameLinux, SetLastError=true)] public static extern string get_statustext(IntPtr lp, int statuscode);
#if lpsolve_unsafe
    [DllImport(dllFileNameLinux, EntryPoint = "get_statustext", SetLastError=true)] private unsafe static extern IntPtr get_statustext_c(IntPtr lp, int statuscode);
#endif
        [DllImport(dllFileNameLinux, SetLastError = true)]
